<template>
    <head>
        <Title>Reporting - Toolstring Coiled Tubing</Title>
    </head>
                                ...
                                <div class="w-full flex flex-col justify-between">
                                    <div>
                                        ...
                                        <div class="mb-4">
                                            ...
                                            <input type="text" id="title" v-model="templateToolstringForm.title"
                                                class="w-full px-3 dark:text-white py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-blue-500 focus:border-blue-500"
                                                required>
                                        </div>
                                        <!-- Client -->
                                        <div class="mb-4">
                                            ...
                                            <input type="text" id="client" v-model="templateToolstringForm.client"
                                                class="w-full px-3 dark:text-white py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-blue-500 focus:border-blue-500"
                                                required>
                                        </div>
                                        <!-- Well -->
                                        <div class="mb-4">
                                            <label for="well"
                                                class="block text-sm font-medium text-gray-700 mb-2 dark:text-white">
                                                Well <span class="text-red-500">*</span>
                                            </label>
                                            <input type="text" id="well" v-model="templateToolstringForm.well"
                                                class="w-full px-3 dark:text-white py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-blue-500 focus:border-blue-500"
                                                required>
                                        </div>
                                        <!-- Well Date -->
                                        <div class="mb-4">
                                            <label for="date"
                                                class="block text-sm font-medium text-gray-700 mb-2 dark:text-white">
                                                Well Date <span class="text-red-500">*</span>
                                            </label>
                            ...
                            <div class="flex flex-col gap-6">
                                ...
                                <div
                                    ...
                                    <div class="flex flex-wrap gap-3 mb-4">
                                        ...
                                        <button :disabled="refreshComponentsLoading" @click="fetchAllToolstringTypes"
                                            class="inline-flex items-center justify-center h-10 px-4 bg-blue-600 text-white rounded-lg shadow-md hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-400 focus:ring-offset-2 transition-all disabled:opacity-50 disabled:cursor-not-allowed">
...
/* ------------------------------ FILTER & SORT ------------------------------ */
const search = ref('');
const selectedSortByFilter = ref({ name: 'Created At', value: 'created_at' });
...
const fetchAllToolstringItems = async (typeId) => {
    loading.value = true;
    try {
        const response = await axios.get(baseUrl + '/api/toolstring-items-search?limit=10', {
...
const fetchAllComponentDimensions = async (itemId) => {
    loading.value = true;
    try {
        const response = await axios.get(`${baseUrl}/api/toolstring-item-dimensions/${itemId}?limit=10`);
