                                    ...
                                    <div class="flex flex-col sm:flex-row gap-4">
                                        <div class="flex w-full">
                                            <button :disabled="AddComponentLoading" @click="handleAddComponent"
                                                class="w-40 inline-flex items-center justify-center gap-2 px-4 mb-3 py-2.5 text-sm bg-blue-600 text-white rounded-lg shadow hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-400 focus:ring-offset-2 transition disabled:opacity-50 disabled:cursor-not-allowed">
                                            ...
                                            <div class="relative mt-1">
                                                ...
                                                <transition leave-active-class="transition duration-100 ease-in"
                                                    ...
                                                    <ComboboxOptions
                                                        ...
                                                        <ComboboxOption v-for="category in categories" :key="category.id"
                                                            :value="category" v-slot="{ selected, active }">
                                                            <li :class="[
                                ...
                                <div class="bg-white dark:bg-slate-800 rounded-xl shadow-md overflow-hidden">
                                    <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                                        ...
                                        <tbody
                                            ...
                                            <!-- Loading State -->
                                            <template v-if="componentListLoading">
                                                <tr v-for="n in 3" :key="n">
                                                    <td class="px-6 py-4 whitespace-nowrap">
                                                        <div
                                                            class="h-4 bg-gray-200 dark:bg-gray-700 rounded animate-pulse w-8">
                                                        </div>
                                                    </td>
                                                    <td class="px-6 py-4 whitespace-nowrap">
                                                        <div
                                            ...
                                            <template v-else>
                                                <tr v-for="(component, index) in componentList" :key="index">
                                                    ...
                                                    <td class="px-6 py-4 whitespace-nowrap text-sm">
                                                        <button @click="removeComponent(index, component)"
                                                            :disabled="component.isRemoving"
                                                            ...
                                                            <div v-if="component.isRemoving" class="spinner mr-2"></div>
                                                            ...
                                                            {{ component.isRemoving ? 'Removing...' : 'Remove' }}
                                                        </button>
                                                    </td>
                                                </tr>
                                                <!-- Empty State -->
                                                <tr v-if="!componentListLoading && componentList.length === 0">
                                                    <td colspan="7"
        ...
        <div class="w-full px-4 py-6">
            <TabGroup>
                ...
                <TabPanels class="mt-6">
                    <!-- Toolstring Coiled Tubing Panel -->
                    <TabPanel class="rounded-xl bg-white dark:bg-slate-800/50 p-6">
                        <div class="space-y-6">
                            <!-- Header Section -->
                                    ...
                                    <div class="space-y-4 sm:space-y-0" :class="{ 'hidden sm:block': !showMobileFilters }">
                                                            ...
                                                            <transition leave-active-class="transition duration-100 ease-in"
                                                                ...
                                                                <ListboxOptions
                                                                    ...
                                                                    <ListboxOption v-slot="{ active, selected }"
                                                                        ...
                                                                        :key="statusItem.name" :value="statusItem"
                                                                        as="template">
                                                                        <li :class="[
                                                                            active ? 'bg-blue-100 text-blue-900 dark:bg-gray-500 dark:text-white' : 'text-gray-900 dark:text-white',
                                                                            'relative cursor-default select-none py-2 pl-10 pr-4',
                                                        ...
                                                        <div class="relative">
                                                            ...
                                                            <transition leave-active-class="transition duration-100 ease-in"
                                                                ...
                                                                <ListboxOptions
                                                                    class="absolute z-50 mt-1 max-h-60 w-full overflow-auto rounded-md bg-white dark:bg-slate-800 py-1 text-base shadow-lg ring-1 ring-black/5 focus:outline-none sm:text-sm">
                                                                    <ListboxOption v-slot="{ active, selected }"
                                                                        v-for="sortByItem in sortByItems"
                                                                        :key="sortByItem.name" :value="sortByItem"
                                                                        as="template">
                                                                        <li :class="[
                                                                            active ? 'bg-blue-100 text-blue-900 dark:bg-gray-500 dark:text-white' : 'text-gray-900 dark:text-white',
                                                                            'relative cursor-default select-none py-2 pl-10 pr-4',
                                                        ...
                                                        <div class="relative">
                                                            ...
                                                            <transition leave-active-class="transition duration-100 ease-in"
                                                                ...
                                                                <ListboxOptions
                                                                    class="absolute z-50 mt-1 max-h-60 w-full overflow-auto rounded-md bg-white dark:bg-slate-800 py-1 text-base shadow-lg ring-1 ring-black/5 focus:outline-none sm:text-sm">
                                                                    <ListboxOption v-slot="{ active, selected }"
                                                                        v-for="pageSizeItem in pageSizeItems"
                                                                        :key="pageSizeItem.name" :value="pageSizeItem"
                                                                        as="template">
                                                                        <li :class="[
                                                                            active ? 'bg-blue-100 text-blue-900 dark:bg-gray-500 dark:text-white' : 'text-gray-900 dark:text-white',
                                                                            'relative cursor-default select-none py-2 pl-10 pr-4',
                                                ...
                                                <SwitchGroup as="div" class="flex items-center space-x-2">
                                                    ...
                                                    <Switch v-model="isDesc" :class="isDesc ? 'bg-blue-600' : 'bg-gray-400'"
                                                        ...
                                                        <span aria-hidden="true"
                                                            :class="isDesc ? 'translate-x-5' : 'translate-x-0'"
                                        ...
                                        <div class="grid grid-cols-1 gap-4 sm:hidden">
                                            ...
                                            <div class="grid grid-cols-2 gap-3">
                                                ...
                                                <div>
                                                    <label
                                                        class="block text-xs font-medium text-gray-700 dark:text-gray-300 mb-1">Sort
                                                        By</label>
                                                    <Listbox v-model="selectedSortByFilter">
                                                        <div class="relative">
                                                            <ListboxButton
                                            ...
                                            <div class="grid grid-cols-2 gap-3">
                                                ...
                                                <div>
                                                    ...
                                                    <div
                                                        ...
                                                        <SwitchGroup as="div" class="flex items-center space-x-2">
                                                            <SwitchLabel as="span"
                                                                class="text-sm text-gray-700 dark:text-white">Asc
                                                            </SwitchLabel>
                                                            <Switch v-model="isDesc"
                                                                :class="isDesc ? 'bg-blue-600' : 'bg-gray-400'"
                                                                ...
                                                                <span class="sr-only">Toggle sort direction</span>
                                                                <span aria-hidden="true"
                                                                    :class="isDesc ? 'translate-x-4' : 'translate-x-0'"
                                                                    class="pointer-events-none inline-block h-4 w-4 transform rounded-full bg-white shadow-lg ring-0 transition duration-200 ease-in-out" />
                                                            </Switch>
                                                            <SwitchLabel as="span"
                                                                class="text-sm text-gray-700 dark:text-white">Desc
                                                            </SwitchLabel>
                                                        </SwitchGroup>
                                                    </div>
                                                </div>
                                                ...
                                                <tr v-for="(template, index) in listTemplates" :key="template.id">
                                                    ...
                                                    <td
                                                        ...
                                                        <div class="flex justify-end gap-2">
                                                            <button
                                                                @click="openModal('update', 'toolstring_coiled_tubing', template)"
                                                            ...
                                                            <button
                                                                @click="openReportModal('create', 'toolstring_coiled_tubing', template)"
                                    ...
                                    <div class="overflow-x-auto">
                                        <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                                            ...
                                            <tbody class="divide-y divide-gray-200 dark:divide-gray-700">
                                                <tr v-for="template in listTemplates" :key="template.id">
                                                    <td
                                                        class="px-6 py-4 whitespace-nowrap text-sm text-gray-900 dark:text-gray-200">
                                                        {{ template.no }}</td>
                                                    <td
...
import {
    ChevronUpDownIcon, CheckIcon, PlusIcon, XMarkIcon
...
/* --------------------------------- MENUS ----------------------------------- */
const menus = [
    { id: 1, name: 'Toolstring Coiled Tubing', link: '/reporting/toolstring-coiled-tubing' },
    { id: 2, name: 'Wellstack', link: '/reporting/wellstack' },
];
...
const fetchAllToolstringReportingDetails = async (templateId) => {
    ...
    try {
        ...
        componentList.value = response.data.map(detail => ({
